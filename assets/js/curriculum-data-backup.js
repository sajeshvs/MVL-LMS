...
const LESSONS_DATA = {
  "AC.3.1.1": {
    ...
    "howMVLDoes": [
      ...
      "Zscaler Private Access → only ZPA-enrolled endpoints can even see internal services",
      "Conditional Access rules lock out non-compliant devices (BitLocker off? Bye)",
      "HR off-boarding feed ⟶ Entra ► user disabled within 30 min of termination"
    ],
    "implementationSteps": [
      {
        "step": 1,
  ...
  "AC.3.1.2": {
    ...
    "why": "For MVL Group operating in our GCC High tenant, this control prevents privilege creep and reduces blast radius if accounts get compromised. Critical for maintaining our SPRS score (83→90), ensuring CMMC Level 2 certification, and protecting our DoD contract eligibility.",
    "whyMatters": [
    ...
    "howMVLDoes": [
      "Role-Based Access Control (RBAC) in Entra ID & M365 groups — users only see apps/data tied to their job role",
      "Privileged Identity Mgmt (PIM) ⟶ time-boxed, just-in-time elevation for admins",
      "Zscaler App Segmentation — maps roles to private apps; HR can't even ping engineering Git repos",
      "SharePoint Sensitivity Labels — auto-restrict download/print on CUI libraries",
      "Intune App Protection Policies — separate corporate vs. personal data on BYOD"
    ],
    "implementationSteps": [
      {
        "step": 1,
      ...
      },
      {
        ...
        "description": "Spreadsheet matrix: role → app → allowed actions"
      },
      {
        "step": 3,
      ...
      },
      {
        ...
        "description": "Monthly PowerShell script dumps role assignments → Sentinel alert if drift > 10%"
      },
      {
        "step": 7,
  ...
  "AT.3.2.1": {
    ...
    "howMVLDoes": [
      "Microsoft Viva Learning → deliver security modules directly in Teams with tracking & reporting",
      "KnowBe4 security awareness platform → phishing simulations + interactive training content",
    ...
    "itPerspective": {
      "title": "IT Professional Implementation",
      "content": "Technical implementation for Security Awareness Training:\n\n• **Microsoft 365/Azure Configuration**: Configure appropriate security policies in Microsoft 365 admin center and Azure AD\n• **Zscaler ZPA Integration**: Ensure access policies align with security awareness training requirements  \n• **Intune Device Management**: Deploy compliance policies for endpoint protection\n• **Defender for Business**: Configure threat protection and monitoring capabilities\n• **Sentinel SIEM**: Set up logging and monitoring for compliance verification\n\n**Implementation Steps:**\n1. Review current configuration against CMMC 3.2.1 requirements\n2. Configure necessary security policies and controls\n3. Test implementation in development environment\n4. Deploy to production with proper change management\n5. Validate effectiveness through security testing\n6. Document configuration for compliance audits\n\n**Tools Used:** Azure AD, Microsoft 365 Admin Center, Intune, Defender for Business, Zscaler ZPA"
    },
    "employeePerspective": {
      "title": "What This Means for Employees",
      "content": "Understanding Security Awareness Training in your daily work:\n\n**What You Need to Know:**\n• This security control helps protect sensitive government information (CUI)\n• Your daily workflows may include additional security steps\n• Following these procedures protects MVL and our government contracts\n\n**Your Responsibilities:**\n• Use your assigned MVL Surface device for work activities\n• Follow authentication prompts and security notifications\n• Report any unusual system behavior to IT immediately\n• Complete required security training modules\n\n**Getting Help:**\n• **IT Help Desk**: Submit ticket via ServiceNow portal\n• **Security Questions**: Contact @SajeshVS (CISO) in Teams\n• **Emergency**: Use #🚨-incidents channel for urgent issues\n• **General Support**: Email support@mvl-group.com\n\n**Remember:** These controls protect both MVL and our government clients' sensitive information."
    },
    "managementPerspective": {
      "title": "Business Impact & Risk Management",
      "content": "Security Awareness Training - Strategic Business Value:\n\n**Compliance Impact:**\n• **CMMC Level 2 Requirement**: Essential for DoD contract eligibility\n• **SPRS Score**: Contributes to target score improvement (83→90)\n• **Audit Readiness**: Demonstrates due diligence in cybersecurity\n• **Risk Mitigation**: Reduces likelihood of data breaches and penalties\n\n**Business Metrics:**\n• **Contract Protection**: Maintains eligibility for $X million in DoD contracts\n• **Insurance Benefits**: May reduce cybersecurity insurance premiums\n• **Competitive Advantage**: CMMC certification differentiates MVL in marketplace\n• **Customer Confidence**: Demonstrates commitment to information security\n\n**Investment ROI:**\n• **Implementation Cost**: One-time configuration and training investment\n• **Ongoing Costs**: Minimal operational overhead with existing tools\n• **Risk Reduction**: Prevents potential $500K+ breach remediation costs\n• **Revenue Protection**: Ensures continued access to government contracts\n\n**Key Success Metrics:** Compliance audit scores, incident reduction, employee adoption rates"
    },
    "mvlTips": [
      "🏢 **MVL Context**: This control is implemented using our GCC High tenant and integrated security stack",
      "🔒 **Security Stack**: Leverages Zscaler ZPA, Defender for Business, and Intune for comprehensive protection",
    ...
    "steps": [
      {
        "step": 1,
        "title": "Assessment",
        "description": "Evaluate current security awareness training implementation against CMMC 3.2.1 requirements"
      },
      {
        "step": 2,
        "title": "Configuration",
    ...
    "quiz": {
      "question": "Which MVL tool is primarily responsible for implementing security awareness training?",
      "options": [
        "Microsoft 365 and Azure AD",
        "Zscaler ZPA",
        "Defender for Business",
      ...
      "correct": 3,
      "explanation": "Security Awareness Training requires coordination across MVL's entire security stack. While each tool has specific roles, effective implementation requires Microsoft 365/Azure AD for identity management, Zscaler ZPA for access control, and Defender for Business for threat protection - all working together in our GCC High environment."
    },
    "resources": [
      {
        "title": "CMMC Model Overview",
        "url": "https://www.acq.osd.mil/cmmc/docs/CMMC_Model_Main_20200203.pdf",
        "description": "Official CMMC documentation for control 3.2.1"
      },
      {
        "title": "NIST SP 800-171r3 Guide",
        "url": "https://nvlpubs.nist.gov/nistpubs/SpecialPublications/800-171r3/NIST.SP.800-171r3.html",
  ...
  "AU.3.3.1": {
    ...
    "why": "For MVL Group operating in our GCC High tenant, this control is critical for maintaining our SPRS score (83→90), ensuring CMMC Level 2 certification, and protecting our DoD contract eligibility. Comprehensive audit logging enables forensic analysis and incident response.",
    "whyMatters": [
    ...
    "howMVLDoes": [
      "Microsoft Sentinel → centralized SIEM collecting logs from all MVL systems and security tools",
      "Azure Monitor + Log Analytics → detailed logging of Azure AD, Office 365, and infrastructure events", 
      "Defender for Business → endpoint activity logging with behavioral analysis and threat detection",
      "Automated log retention policies → 7 years for CUI-related events, 1 year for general security logs"
    ],
    "implementationSteps": [
      {
        "step": 1,
    ...
    "itPerspective": {
      "title": "IT Professional Implementation",
      "content": "Technical implementation for Create Audit Records:\n\n• **Microsoft 365/Azure Configuration**: Configure appropriate security policies in Microsoft 365 admin center and Azure AD\n• **Zscaler ZPA Integration**: Ensure access policies align with create audit records requirements  \n• **Intune Device Management**: Deploy compliance policies for endpoint protection\n• **Defender for Business**: Configure threat protection and monitoring capabilities\n• **Sentinel SIEM**: Set up logging and monitoring for compliance verification\n\n**Implementation Steps:**\n1. Review current configuration against CMMC 3.3.1 requirements\n2. Configure necessary security policies and controls\n3. Test implementation in development environment\n4. Deploy to production with proper change management\n5. Validate effectiveness through security testing\n6. Document configuration for compliance audits\n\n**Tools Used:** Azure AD, Microsoft 365 Admin Center, Intune, Defender for Business, Zscaler ZPA"
    },
    "employeePerspective": {
      "title": "What This Means for Employees",
      "content": "Understanding Create Audit Records in your daily work:\n\n**What You Need to Know:**\n• This security control helps protect sensitive government information (CUI)\n• Your daily workflows may include additional security steps\n• Following these procedures protects MVL and our government contracts\n\n**Your Responsibilities:**\n• Use your assigned MVL Surface device for work activities\n• Follow authentication prompts and security notifications\n• Report any unusual system behavior to IT immediately\n• Complete required security training modules\n\n**Getting Help:**\n• **IT Help Desk**: Submit ticket via ServiceNow portal\n• **Security Questions**: Contact @SajeshVS (CISO) in Teams\n• **Emergency**: Use #🚨-incidents channel for urgent issues\n• **General Support**: Email support@mvl-group.com\n\n**Remember:** These controls protect both MVL and our government clients' sensitive information."
    },
    "managementPerspective": {
      "title": "Business Impact & Risk Management",
      "content": "Create Audit Records - Strategic Business Value:\n\n**Compliance Impact:**\n• **CMMC Level 2 Requirement**: Essential for DoD contract eligibility\n• **SPRS Score**: Contributes to target score improvement (83→90)\n• **Audit Readiness**: Demonstrates due diligence in cybersecurity\n• **Risk Mitigation**: Reduces likelihood of data breaches and penalties\n\n**Business Metrics:**\n• **Contract Protection**: Maintains eligibility for $X million in DoD contracts\n• **Insurance Benefits**: May reduce cybersecurity insurance premiums\n• **Competitive Advantage**: CMMC certification differentiates MVL in marketplace\n• **Customer Confidence**: Demonstrates commitment to information security\n\n**Investment ROI:**\n• **Implementation Cost**: One-time configuration and training investment\n• **Ongoing Costs**: Minimal operational overhead with existing tools\n• **Risk Reduction**: Prevents potential $500K+ breach remediation costs\n• **Revenue Protection**: Ensures continued access to government contracts\n\n**Key Success Metrics:** Compliance audit scores, incident reduction, employee adoption rates"
    },
    "mvlTips": [
      "🏢 **MVL Context**: This control is implemented using our GCC High tenant and integrated security stack",
      "🔒 **Security Stack**: Leverages Zscaler ZPA, Defender for Business, and Intune for comprehensive protection",
    ...
    "steps": [
      {
        "step": 1,
        "title": "Assessment",
        "description": "Evaluate current create audit records implementation against CMMC 3.3.1 requirements"
      },
      {
        "step": 2,
        "title": "Configuration",
    ...
    "quiz": {
      "question": "Which MVL tool is primarily responsible for implementing create audit records?",
      "options": [
        "Microsoft 365 and Azure AD",
        "Zscaler ZPA",
        "Defender for Business",
      ...
      "correct": 3,
      "explanation": "Create Audit Records requires coordination across MVL's entire security stack. While each tool has specific roles, effective implementation requires Microsoft 365/Azure AD for identity management, Zscaler ZPA for access control, and Defender for Business for threat protection - all working together in our GCC High environment."
    },
    "resources": [
      {
        "title": "CMMC Model Overview",
        "url": "https://www.acq.osd.mil/cmmc/docs/CMMC_Model_Main_20200203.pdf",
        "description": "Official CMMC documentation for control 3.3.1"
      },
      {
        "title": "NIST SP 800-171r3 Guide",
        "url": "https://nvlpubs.nist.gov/nistpubs/SpecialPublications/800-171r3/NIST.SP.800-171r3.html",
  ...
  "CM.3.4.1": {
    ...
    "why": "For MVL Group operating in our GCC High tenant, this control is critical for maintaining our SPRS score (83→90), ensuring CMMC Level 2 certification, and protecting our DoD contract eligibility. Baseline configurations provide the foundation for secure, consistent system deployments.",
    "whyMatters": [
    ...
    "howMVLDoes": [
      "Microsoft Intune → standardized device configuration profiles for all MVL Surface devices",
      "Azure Policy → automated governance and compliance checking for cloud resources",
      "Windows Autopilot → zero-touch deployment with pre-configured security baselines",
      "Configuration Manager → enterprise-scale configuration management and compliance reporting"
    ],
    "implementationSteps": [
      {
        "step": 1,
    ...
    "itPerspective": {
      "title": "IT Professional Implementation",
      "content": "Technical implementation for Establish Baseline Configurations:\n\n• **Microsoft 365/Azure Configuration**: Configure appropriate security policies in Microsoft 365 admin center and Azure AD\n• **Zscaler ZPA Integration**: Ensure access policies align with establish baseline configurations requirements  \n• **Intune Device Management**: Deploy compliance policies for endpoint protection\n• **Defender for Business**: Configure threat protection and monitoring capabilities\n• **Sentinel SIEM**: Set up logging and monitoring for compliance verification\n\n**Implementation Steps:**\n1. Review current configuration against CMMC 3.4.1 requirements\n2. Configure necessary security policies and controls\n3. Test implementation in development environment\n4. Deploy to production with proper change management\n5. Validate effectiveness through security testing\n6. Document configuration for compliance audits\n\n**Tools Used:** Azure AD, Microsoft 365 Admin Center, Intune, Defender for Business, Zscaler ZPA"
    },
    "employeePerspective": {
      "title": "What This Means for Employees",
      "content": "Understanding Establish Baseline Configurations in your daily work:\n\n**What You Need to Know:**\n• This security control helps protect sensitive government information (CUI)\n• Your daily workflows may include additional security steps\n• Following these procedures protects MVL and our government contracts\n\n**Your Responsibilities:**\n• Use your assigned MVL Surface device for work activities\n• Follow authentication prompts and security notifications\n• Report any unusual system behavior to IT immediately\n• Complete required security training modules\n\n**Getting Help:**\n• **IT Help Desk**: Submit ticket via ServiceNow portal\n• **Security Questions**: Contact @SajeshVS (CISO) in Teams\n• **Emergency**: Use #🚨-incidents channel for urgent issues\n• **General Support**: Email support@mvl-group.com\n\n**Remember:** These controls protect both MVL and our government clients' sensitive information."
    },
    "managementPerspective": {
      "title": "Business Impact & Risk Management",
      "content": "Establish Baseline Configurations - Strategic Business Value:\n\n**Compliance Impact:**\n• **CMMC Level 2 Requirement**: Essential for DoD contract eligibility\n• **SPRS Score**: Contributes to target score improvement (83→90)\n• **Audit Readiness**: Demonstrates due diligence in cybersecurity\n• **Risk Mitigation**: Reduces likelihood of data breaches and penalties\n\n**Business Metrics:**\n• **Contract Protection**: Maintains eligibility for $X million in DoD contracts\n• **Insurance Benefits**: May reduce cybersecurity insurance premiums\n• **Competitive Advantage**: CMMC certification differentiates MVL in marketplace\n• **Customer Confidence**: Demonstrates commitment to information security\n\n**Investment ROI:**\n• **Implementation Cost**: One-time configuration and training investment\n• **Ongoing Costs**: Minimal operational overhead with existing tools\n• **Risk Reduction**: Prevents potential $500K+ breach remediation costs\n• **Revenue Protection**: Ensures continued access to government contracts\n\n**Key Success Metrics:** Compliance audit scores, incident reduction, employee adoption rates"
    },
    "mvlTips": [
      "🏢 **MVL Context**: This control is implemented using our GCC High tenant and integrated security stack",
      "🔒 **Security Stack**: Leverages Zscaler ZPA, Defender for Business, and Intune for comprehensive protection",
    ...
    "steps": [
      {
        "step": 1,
        "title": "Assessment",
        "description": "Evaluate current establish baseline configurations implementation against CMMC 3.4.1 requirements"
      },
      {
        "step": 2,
        "title": "Configuration",
    ...
    "quiz": {
      "question": "Which MVL tool is primarily responsible for implementing establish baseline configurations?",
      "options": [
        "Microsoft 365 and Azure AD",
        "Zscaler ZPA",
        "Defender for Business",
      ...
      "correct": 3,
      "explanation": "Establish Baseline Configurations requires coordination across MVL's entire security stack. While each tool has specific roles, effective implementation requires Microsoft 365/Azure AD for identity management, Zscaler ZPA for access control, and Defender for Business for threat protection - all working together in our GCC High environment."
    },
    "resources": [
      {
        "title": "CMMC Model Overview",
        "url": "https://www.acq.osd.mil/cmmc/docs/CMMC_Model_Main_20200203.pdf",
        "description": "Official CMMC documentation for control 3.4.1"
      },
      {
        "title": "NIST SP 800-171r3 Guide",
        "url": "https://nvlpubs.nist.gov/nistpubs/SpecialPublications/800-171r3/NIST.SP.800-171r3.html",
  ...
  "IA.3.6.1": {
    ...
    "why": "For MVL Group operating in our GCC High tenant, this control is critical for maintaining our SPRS score (83→90), ensuring CMMC Level 2 certification, and protecting our DoD contract eligibility. Proper user identification enables accountability and audit trails.",
    "whyMatters": [
    ...
    "howMVLDoes": [
      "Azure Active Directory → unique user identities with UPN format (user@mvl-group.com)",
      "Managed device identities → every Surface device has unique Azure AD device identity",
      "Service principal accounts → applications and automated processes use dedicated service identities",
      "Guest user management → external contractors get time-limited guest identities with restricted access"
    ],
    "implementationSteps": [
      {
        "step": 1,
  ...
  "SC.3.13.1": {
    ...
    "why": "For MVL Group operating in our GCC High tenant, this control is critical for maintaining our SPRS score (83→90), ensuring CMMC Level 2 certification, and protecting our DoD contract eligibility. Communications monitoring prevents data exfiltration and detects advanced persistent threats.",
    "whyMatters": [
    ...
    "howMVLDoes": [
      "Zscaler ZPA → zero-trust network access with full inspection of all traffic flows",
      "Azure Firewall → next-generation firewall with threat intelligence and application control",
      "Microsoft Defender for Cloud Apps → cloud access security broker (CASB) monitoring SaaS traffic",
      "Sentinel network analytics → ML-powered detection of suspicious communication patterns"
    ],
    "implementationSteps": [
      {
        "step": 1,
