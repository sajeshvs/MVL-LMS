...
const LESSONS_DATA = {
  "AC.3.1.1": {
    ...
    "howMVLDoes": [
      ...
      "Zscaler Private Access (ZPA) †’ Zero Trust Network Access ensuring only enrolled, compliant endpoints access internal resources",
      "Conditional Access Policies †’ Automated enforcement of device compliance, location restrictions, and risk-based access controls",
      "Automated Identity Lifecycle Management †’ HR system integration ensures immediate account provisioning and deprovisioning",
      "Privileged Access Management (PAM) †’ Just-in-time access elevation with approval workflows for administrative functions"
    ],
    "implementationSteps": [
      {
        "step": 1,
  ...
  "AC.3.1.2": {
    ...
    "howMVLDoes": [
      "Role-Based Access Control (RBAC) †’ Entra ID groups mapped to business functions with granular permission assignments",
      "Privileged Identity Management (PIM) †’ Time-boxed, just-in-time elevation for administrative functions with approval workflows",
      "Zscaler App Segmentation †’ Role-based micro-segmentation ensuring users only access applications relevant to their job function",
      "SharePoint Sensitivity Labels †’ Automated content classification with role-based access restrictions and DLP policies",
      "Microsoft Intune App Protection †’ Conditional access policies separating corporate and personal data on managed devices",
      "Regular Access Reviews †’ Quarterly certification process ensuring access rights remain appropriate and current"
    ],
    "implementationSteps": [
      {
        "step": 1,
  ...
  "AC.3.1.3": {
    ...
    "howMVLDoes": [
      "Microsoft Purview Information Protection †’ Automatic classification and labeling of CUI with data loss prevention policies",
      "Zscaler Internet Access (ZIA) †’ Web filtering and SSL inspection preventing CUI transmission to unauthorized destinations",
      "Microsoft Defender for Cloud Apps †’ Cloud app security broker (CASB) monitoring and controlling CUI flow in SaaS applications",
      "Network Segmentation †’ Zscaler ZPA micro-tunnels ensuring CUI remains within authorized network boundaries",
      "Endpoint DLP Policies †’ Microsoft Purview endpoint protection preventing CUI extraction via USB, email, or file sharing",
      "Azure Information Protection †’ Rights management and persistent protection following CUI throughout its lifecycle"
    ],
    "itPerspective": {
      "title": "IT Professional Implementation",
